...
public class VmsController {
	...
	// @CrossOrigin
	public String startProcess(@RequestBody String inputJson, @PathVariable String processKey,
	...
	// @CrossOrigin
	public String fetchAndLockTask(@RequestBody String inputJson, @PathVariable String topicName,
	...
	public String requirementFallback(@PathVariable String reqId, HttpServletRequest request,
