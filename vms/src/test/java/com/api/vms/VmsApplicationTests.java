...
@AutoConfigureStubRunner(stubsMode = StubRunnerProperties.StubsMode.LOCAL, ids = "com.api:vmsnew:+:8089")
class VmsApplicationTests {
	...
	@Test
	public void given_WhenPassReqIdReturnReqDetails() throws Exception {

		mockMvc.perform(MockMvcRequestBuilders.post("/getRequirementDetailsApi").queryParam("inputJson",
				"REQ_28382020170712788").contentType(MediaType.APPLICATION_JSON)).andExpect(MockMvcResultMatchers.status().is(200))
